      ...
      <section className="rounded-[2rem] border border-border bg-gradient-to-br from-white via-sky-50/70 to-cyan-50/80 p-6 shadow-sm dark:from-card dark:via-card dark:to-card">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full bg-sky-600 px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-sky-700"
          >
                  ...
                  <tr>
                    <td colSpan={7} className="px-5 py-14 text-center">
                      <div className="mx-auto max-w-md">
                        ...
                        <Link
                          href="/internal/subscriptions/new"
                          className="mt-5 inline-flex items-center gap-2 rounded-full bg-sky-600 px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-sky-700"
                        >
                          <IconPlus className="h-4 w-4" />
                          Create Subscription
                        </Link>
                    ...
                    return (
                      <tr key={subscription.id} className="hover:bg-muted/20">
                        ...
                        <td className="px-5 py-4 text-right">
                          <Link
                            href={`/internal/subscriptions/${subscription.id}`}
...
function buildStatusHref(
  ...
  return `/internal/subscriptions?${params.toString()}`
}
